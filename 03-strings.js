...
//  property: .leength -> 문자열 길이 
console.log(s1, ", length=", s1.length);

//  문자열 추출 메서드 : zero-base(인덱스 0번부터 시작)
...
console.log("2st Search:", pos);    // 두 번째 Java의 위치
...
//  \' : 작은 따옴표 
//  \" : 큰 따옴표
//  \` : 백틱(ES6) 여러줄 문자열 한번에 처리 
//  \$ : 달러 기호(ES6) 외부 변수를 문자열 내부에 직접 연결할 수 있음 
